...
export bases, Basis, GenericBasis, CompositeBasis,
        ...
        operators, Operator, expect, identityoperator, ptrace, embed, ishermitian,
        operators_dense, DenseOperator, projector, ishermitian,
        operators_sparse, SparseOperator, diagonaloperator, ishermitian,
        ...
        metrics, tracenorm, tracenorm_general, tracedistance, tracedistance_general,
                entropy_vn, fidelity,
        spectralanalysis, eig, eigvals, eigvals!, simdiag,
